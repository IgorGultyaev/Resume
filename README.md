...
## Мои работы по курсу «Основы Java» <img src="./img/netology.jpg" alt="Нетология">
...
## Домашние задания по курсу «Git - система контроля версий» <img src="./img/netology.jpg" alt="Нетология"> <img src="./img/git.jpg" alt="Git">

#### [5.  Внедрение системы контроля версий](https://github.com/IgorGultyaev/git-homeworks/tree/master/introduction) 

> [5.1.1 Демонстрация](https://github.com/IgorGultyaev/NeuroStartUp)  
> [5.1.2 Импорт существующего проекта](https://github.com/IgorGultyaev/NeuroStartUp.git)  
> [5.1.3 Откат изменений](https://github.com/IgorGultyaev/NeuroStartUpRevent)  


#### [5.2 История и работа с ветками](https://github.com/IgorGultyaev/git-homeworks/tree/master/branch)

> [5.2.1 Создание веток](https://github.com/IgorGultyaev/NeuroStartUpBranch)  
> [5.2.2 Слияние изменений](https://github.com/IgorGultyaev/NeuroStartUp2)  
> [5.2.3 Работа с историей и переключение между коммитами] ()



#### [5.3.Командная работа](https://github.com/IgorGultyaev/git-homeworks/tree/master/remote)

> [5.3.1 Конфликт при push'е](https://github.com/IgorGultyaev/NeuroStartUp2)  
> [5.3.2 Работа с issues](https://github.com/netology-code/git-homeworks-neuro-issues/issues/8360)  
> [5.3.3 Работа с issues](https://github.com/netology-code/git-homeworks-neuro-issues/issues/8361)  
> [5.3.4 Pull-Request](https://github.com/IgorGultyaev/git-homeworks-neuro-fork.git)
...
## Мои работы по курсу «Java Core»  <img src="./img/netology.jpg" alt="Нетология">

# 6. Домашние задания по курсу «Java Core»

## Блок 6. Stream API, работа с файлами и сборка проектов

6.1 [Лямбда-выражения и функциональные интерфейсы](https://github.com/netology-code/jd-homeworks/blob/master/lambda/README.md)
> [6.1.2 Калькулятор](https://github.com/IgorGultyaev/Calculator)  
...
## Блок 7. Тестирование программы

7.1 [Тестирование кода и Unit-тесты](https://github.com/netology-code/jd-homeworks/tree/master/junit)
> [7.1.1 Использование JUnit](https://github.com/IgorGultyaev/ParserTo/tree/ParserTest)  
> [7.7.2 JUnit + Hamcrest]

7.3[Mockito. Мокирование вызовов](https://github.com/netology-code/jd-homeworks/tree/master/mocks)
> [7.3.1 Тестирование сервиса отправки сообщений](https://github.com/IgorGultyaev/geo-service-master)  
> [7.3.2 Тестирование сервиса медицинских показаний](https://github.com/IgorGultyaev/healthcare-service-master)

## Блок 8 Работа с сетью

8.1 [Основы работы с сетью. Модель OSI](https://github.com/netology-code/jd-homeworks/tree/master/network)
> [8.1.1 Клиент-серверное приложение](https://github.com/IgorGultyaev/OSI_LE_Server/tree/main)  
> [8.1.2 Клиент-сервер с рюшечками](https://github.com/IgorGultyaev/OSI_LE_Server/tree/feature)

8.2 [Протокол HTTP. Вызовы удаленных серверов](https://github.com/netology-code/jd-homeworks/tree/master/http)
> [8.2.1 Запрос на получение списка фактов о кошках](https://github.com/IgorGultyaev/listRequest)  
> [8.2.2 Чтение данных API NASA](https://github.com/IgorGultyaev/ReadingNASAAPIdata)

## Блок 8.3. Структура JVM
8.4 [JVM. Организация памяти, сборщики мусора, VisualVM](/jvm)
> [8.4.1 Понимание JVM](https://github.com/IgorGultyaev/UnderstandingJVM)  
> [8.4.2 Исследование JVM через VisualVM](https://github.com/IgorGultyaev/UnderstandingJVM)
...
# То, что я планирую разбирать самостоятельно
